...
fun <T, E : Throwable> eventually(duration: Duration, exceptionClass: Class<E>, f: () -> T): T {
    ...
    throw Exception("Test failed after ${duration.seconds} seconds; attempted $times times$underlyingCause", lastError)
}
...
fun <T> eventually(duration: Duration, predicate: (T) -> Boolean, f: () -> T): T {
    ...
    throw Exception("Test failed after ${duration.seconds} seconds; attempted $times times")
}